  ...
  <div class="verifycontract">
    <div class="container-inner" >
      <div class="sections">
        ...
        <verifycontractdata :language="language"></verifycontractdata>
...
import VerifyContractData from "../../../components/index/ca_address/VerifyContractData";
...
export default {
  ...
  components: {
    ...
    verifycontractdata: VerifyContractData,
    // message: message,
    foot: foot
  },
  data() {
