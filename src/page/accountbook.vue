    ...
    <div class="container-inner" >
      <div class="sections">
        <nav-bar  @languageSwitched="listenLangSwitch" :is-show-nav="true"
          currentSection="accountbook" :sectionRefs="$refs" :language="language"/>
        <notice :language="language"></notice>
        <selectinput :language="language"></selectinput>
        <bookdata :language="language"></bookdata>
...
import bookdata from "../components/accountbook/BookData";
...
export default {
  ...
  methods: {
    listenLangSwitch: function(language) {
      ...
      // this.$router.replace({ path: "/accountbook", query: data });
